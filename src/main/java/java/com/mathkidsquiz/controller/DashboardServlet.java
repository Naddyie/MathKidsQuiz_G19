...
import java.com.mathkidsquiz.model.User; // Assuming you have your User model here
...
@WebServlet("/dashboard.jsp") // This servlet handles the /dashboard URL for all users
